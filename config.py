...
# ---------------------------------------------
# The database, schema and table have previously
# been created using sql script 'schema.sql'
# as well as the user and grant permissions which
# have been created with 'user.sql' script
DB_CONN_STRING = os.getenv('DB_CONN_STRING', 'postgres://sre_user:<change_password>@sre-challenge-rds-production-database.chi7dtdagden.eu-west-1.rds.amazonaws.com/proddatabase')
...
S3_LEGACY_BUCKET_NAME = os.getenv('S3_LEGACY_BUCKET_NAME', 'sre-challenge-s3-legacy-bucket')
S3_PRODUCTION_BUCKET_NAME = os.getenv('S3_PRODUCTION_BUCKET_NAME', 'sre-challenge-s3-production-bucket')

# S3 prefixes
LEGACY_PREFIX = os.getenv('LEGACY_PREFIX', 'image')
PRODUCTION_PREFIX = os.getenv('PRODUCTION_PREFIX', 'avatar')

# S3 connection details
S3_ENDPOINT_URL = os.getenv('S3_ENDPOINT_URL', 'https://s3.eu-west-1.amazonaws.com')
